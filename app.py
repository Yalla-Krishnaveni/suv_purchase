...
def predict():
    ...
    print(output)
    if output[0] == 0:
        return render_template('index.html', prog=f'The person will not be able to purchase SUV')
    else:
        return render_template('index.html', prog=f'The person will be able to purchase SUV')
